...
public class JLGGroupData {
    ...
    private final BigDecimal emiamt;
    ...
    public static JLGGroupData instance(final Long groupId, final String groupName, final Long staffId, final String staffName, final Long levelId,
            final String levelName,final String centerName,final BigDecimal emiamt){
        return new JLGGroupData(groupId, groupName, staffId, staffName, levelId, levelName, null,centerName,emiamt);
    }
    
    public static JLGGroupData withClients(final JLGGroupData group, Collection<JLGClientData> clients){
        return new JLGGroupData(group.groupId, group.groupName, group.staffId, group.staffName, group.levelId, group.levelName, clients,null,null);
    }
    ...
    private JLGGroupData(final Long groupId, final String groupName, final Long staffId, final String staffName, final Long levelId,
            final String levelName, final Collection<JLGClientData> clients,final String centerName,final BigDecimal emiamt) {
