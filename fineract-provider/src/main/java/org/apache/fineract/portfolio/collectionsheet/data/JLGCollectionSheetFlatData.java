...
public class JLGCollectionSheetFlatData {
    ...
    private BigDecimal emiamt = BigDecimal.ZERO;
    ...
    public JLGCollectionSheetFlatData(final String groupName, final Long groupId, final Long staffId, final String staffName,
            ...
            final EnumOptionData attendanceType, final BigDecimal feeDue, final BigDecimal feePaid,final String centerName,final BigDecimal emiamt) {
    ...
    public JLGGroupData getJLGGroupData() {
        ...
        return JLGGroupData.instance(this.groupId, this.groupName, this.staffId, this.staffName, this.levelId, this.levelName,this.centerName,this.emiamt);
    }
